...
pub fn transform_openai_request(
    ...
    let original_model_lower = request.model.to_lowercase();
    ...
    let requested_claude_thinking = original_model_lower.contains("claude")
        && original_model_lower.ends_with("-thinking");
    let is_claude_thinking = mapped_model_lower.ends_with("-thinking") || requested_claude_thinking;
